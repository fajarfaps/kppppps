...
# Load model
model1 = load_model('C:\\Users\\fajar\\model_paru.h5')
model2 = load_model('C:\\Users\\fajar\\model_paru.h5')
# Isi class_labels
...
def home_page():
    ...
    st.markdown("---")
    image = Image.open('C:\\Users\\fajar\\Vege Healt.png')
    st.image('Vege Healt.png', caption='')
    st.write("")
    st.markdown("---")
    image = Image.open('C:\\Users\\fajar\\Vege Tutor.png')
    ...
    with col1:
        ...
        image = Image.open('image_daun\\vocab.jpg')
    ...
    with col2:
        ...
        image = Image.open('image_daun\\confus.jpg')
        st.image(image, caption='', use_column_width=True)
    ...
    with col3:
        ...
        image = Image.open('image_daun\\acc_class.jpg')
        st.image(image, caption='', use_column_width=True)
    ...
    with col1:
        ...
        image = Image.open('image_daun\\acc_epoch.jpg')
        st.image(image, caption='', use_column_width=True)
    ...
    with col3:
        ...
        image = Image.open('image_daun\\loss_epoch.jpg')
        st.image(image, caption='', use_column_width=True)
